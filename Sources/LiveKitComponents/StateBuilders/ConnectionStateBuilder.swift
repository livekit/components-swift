...
{
    public typealias DisconnectedComponentBuilder<Content: View> = (_ disconnectError: LiveKitError?) -> Content
    ...
    public var body: some View {
        ...
        case .disconnected: return AnyView(disconnected(room.disconnectError))
